(define (domain wargame)
  ...
  (:action evade-fourth-on-fourth-more-than-two-left
    :parameters 
	(?b1 ?b2 ?b3 ?r1 - fighter)
    :precondition 
	(and 
  ...
  (:action evade-fourth-on-fourth-two-left
    :parameters 
	(?b1 ?b2 ?r1 - fighter)
    :precondition 
	(and 
  ...
  (:action evade-fifth-on-fifth-more-than-two-left
    :parameters 
	(?b1 ?b2 ?b3 ?r1 - fighter)
    :precondition 
	(and 
  ...
  (:action evade-fifth-on-fifth-two-left
    :parameters 
	(?b1 ?b2 ?r1 - fighter)
    :precondition 
	(and 
